...
import { PacientePage } from './pages/SystemPages/PatientsPage/PatientsPage';  // Importação correta
        ...
        <BrowserRouter>
          <Template>
            <Routes>
              ...
              <Route
                path={"/patients"}
                element={<PrivateRoute element={<PacientePage />} />} // Corrigido para PacientePage
              />
              <Route
                path={"/patients/add"}
